...
public class BiletDAO {
    ...
    public List<Bilet> list() {
        ...
        return jdbcTemplate.query(sql, BeanPropertyRowMapper.newInstance(Bilet.class));
    }
    ...
    public Bilet get(int id) {
        ...
        return jdbcTemplate.queryForObject(sql, BeanPropertyRowMapper.newInstance(Bilet.class), id);
    }
